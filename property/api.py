...
from .serializers import PropertiesDetailSerializer, PropertiesListSerializer, ReservationListSerializer
...
def properties_list(request):
    ...
    checkout_date = request.GET.get('checkinOut', '')
    ...
    if country:
        properties = properties.filter(country=guests)
...
def toggle_favorite(request, pk):
    ...
    if request.user in property.favorited.all():
        ...
        return JsonResponse({'is favorited': False})
